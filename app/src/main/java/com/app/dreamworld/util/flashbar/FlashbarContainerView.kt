...
import com.app.dreamworld.util.flashbar.Flashbar.Companion.DURATION_INDEFINITE
import com.app.dreamworld.util.flashbar.Flashbar.DismissEvent
import com.app.dreamworld.util.flashbar.Flashbar.DismissEvent.*
import com.app.dreamworld.util.flashbar.Flashbar.Vibration.DISMISS
...
internal class FlashbarContainerView(context: Context)
    ...
    internal fun adjustOrientation(activity: Activity) {
        ...
        val navigationBarSize = activity.getNavBarHeight() + 20
