package com.app.dreamworld.util.extension
...
fun isLoggedIn(): Boolean {
    return !TextUtils.isEmpty(BaseApplication.sharedPreference.getPrefModel(EasyPref.USER_DATA, User::class.java)?.userId)
}
