...
import com.app.dreamworld.util.flashbar.Flashbar
import com.app.dreamworld.util.flashbar.FlashAnim
...
//            .title(context.getString(R.string.app_name))
            .message(this).backGroundDrawable(ContextCompat.getDrawable(context, drawable)!!).iconDrawable(ContextCompat.getDrawable(context, iconDrawable)!!).enableSwipeToDismiss().duration(duration).enterAnimation(
                FlashAnim.with(context).animateBar().duration(750).alpha().overshoot()).exitAnimation(
                FlashAnim.with(context).animateBar().duration(400).accelerateDecelerate())
